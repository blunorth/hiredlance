...
<head>
    ...
    <title>Hiredlance | Profile</title>
	...
	<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
						...
						<ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
							...
							<li class="dropdown">
								<a href="freelancers.html">For Employers</a>
								<ul class="dropdown-menu animated fadeOutUp">
								</ul>
							</li>
							
							<li class="dropdown">
								<a href="browse-category.html">For Freelancers</a>
								<ul class="dropdown-menu animated fadeOutUp">
								</ul>
							</li>
							...
							<li class="dropdown">
								<a href="browse-job.html">Browse</a>
								<ul class="dropdown-menu animated fadeOutUp">
								</ul>
							</li>
		...
		<div class="page-title">
			<div class="container">
				...
				<div class="col-sm-5 text-right mrg-top-30">
					<button type="submit" class="btn btn-m btn-success">Download CV</button>
				</div>
			</div>
		</div>
		<!-- ======================= End Page Title ===================== -->
		...
		<section>
			<div class="container">
						...
						<div class="detail-wrapper">
							<div class="detail-wrapper-body">
								...
								<div class="text-center mrg-bot-30">
									<img src="assets/img/hluser.jpg" class="img-circle width-100" alt=""/>
									<h4 class="meg-0">Stanley Ugochukwu</h4>
									<span>Front End Designer</span>
								</div>
								
								<div class="row">
									<div class="col-sm-4 mrg-bot-10">
										<i class="ti-location-pin padd-r-10"></i>34 Alex Ekwueme Drive, Ogui Layout, Enugu
									</div>
									<div class="col-sm-4 mrg-bot-10">
										<i class="ti-email padd-r-10"></i>stanugo@email.com
									</div>
									<div class="col-sm-4 mrg-bot-10">
										<i class="ti-mobile padd-r-10"></i>0809876543
									</div>
									<div class="col-sm-4 mrg-bot-10">
										<i class="ti-credit-card padd-r-10"></i>N2,500/Hour
									</div>
									<div class="col-sm-4 mrg-bot-10">
							...
							<div class="detail-wrapper-body">
								...
								<div class="edu-history info">
									...
									<div class="detail-info">
										<h3>University</h3>
										<i>2008 - 2012</i>
										<span>University of Ibadan <i>Computer Science</i></span>
								...
								<div class="edu-history danger">
									...
									<div class="detail-info">
										...
										<i>2008 - 2012</i>
										<span>Kings College <i>WAEC</i></span>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
									</div>
								</div>
								...
								<div class="edu-history success">
									...
									<div class="detail-info">
										...
										<i>2008 - 2012</i>
										<span>Ile-Ife Grammar School <i>First School Leaving Cert</i></span>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin a ipsum tellus. Interdum et malesuada fames ac ante ipsum primis in faucibus.</p>
									</div>
								</div>
								...
								<div class="widget-boxed-body">
									<div class="side-list no-border">
										<ul>
											...
											<li><i class="ti-world padd-r-10"></i>https://www.stanugo.com</li>
											<li><i class="ti-mobile padd-r-10"></i>0809876543</li>
											<li><i class="ti-email padd-r-10"></i>stanugo@email.com</li>
				...
				<div class="row">
					<div class="col-md-12">
						<h4 class="mrg-bot-20">Recent Candidate</h4>
					</div>
				</div>
				<!-- End Row -->
				...
				<div class="row">
					...
					<div class="col-md-3 col-sm-6 mrg-bot-30">
						<div class="contact-box">
							...
							<div class="contact-img">
								<img src="assets/img/hluser.jpg" class="img-circle img-responsive" alt="">
							</div>
							
							<div class="contact-caption">
								<h4 class="font-16 font-midium">Akin Omotayo</h4>
								<span>Web Designer(3 Year Exp.)</span>
							</div>
							
							<div class="contact-action">
								<a href="#" class="btn-square-40" data-toggle="tooltip" title="Facebook">
									<i class="facebook-cl fa fa-facebook" aria-hidden="true"></i>
								</a>
								<a href="#" class="btn-square-40" data-toggle="tooltip" title="Twitter">
									<i class="twitter-cl fa fa-twitter" aria-hidden="true"></i>
								</a>
								<a href="#" class="btn-square-40" data-toggle="tooltip" title="Google Plus">
									<i class="google-plus-cl fa fa-google-plus" aria-hidden="true"></i>
								</a>
								<a href="#" class="btn-square-40" data-toggle="tooltip" title="Instagram">
									<i class="instagram-cl fa fa-instagram" aria-hidden="true"></i>
								</a>
							</div>
							...
							<div class="contact-footer">
								...
								<a href="profile.html" class="left-br col-half">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="copyright text-center">
								<p>&copy; Copyright 2018 | Hiredlance</a></p>
							</div>
						</div>
					</div>
